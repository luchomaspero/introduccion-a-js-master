...
Estas variables tienen que ser populadas por los datos que ingrese el usuario
Ejecutar la funcion con estos datos
Imprimir el resultado en la consola*/

/*
function calcularEdadUsuario(añoActual,añoNac) {
    return restar(añoActual,añoNac)
}

let añoActual = Number(prompt('En qué año estamos?'))
let añoNac = Number(prompt('En qué año naciste?',))


console.log('Entonces tenés ' + calcularEdadUsuario(añoActual, añoNac) + ' años, alto viejo')
*/
...
let resultado
if (operador === '+') {
    resultado = sumar(uno, cinco)
}   else {resultado = restar(uno, cinco)} 

console.log('El resultado de ' + uno + ' ' + operador + ' ' + cinco + ' es ' + resultado)
*/
...
} else { console.log(`No entiendo el operador ${operador}`) }
