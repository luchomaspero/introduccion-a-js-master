...
//nuestroTitulo.innerText = 'Puedo cambiar el título desde JavaScript!'
...
const elementoDeh1 = document.querySelector('h1')
console.log(elementoDeh1.textContent)
...
elementoDeh1.textContent = 'El nuevo título'
...
const primerTexto = document.querySelector('p')
//primerTexto.style.backgroundColor = 'black'
//primerTexto.style.color = 'white'

const github = document.querySelector('.website')
...
nuevoParrafo.appendChild(imagenCabecera)
nodoPagina.appendChild(nuevoParrafo)
