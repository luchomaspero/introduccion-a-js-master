...
const comidasFavoritas = ['milanesa con fritas', 'ravioles', 'camarones', 'sushi']
...
comidasFavoritas.push('langostinos')
...
// TAREA: Calcular el promedio de todos los números en un array de números. 
// (y ponerlo en una función)
// ej.: calcularPromedio([10,5,4,2,8])


/*
const calcularPromedio = [10,5,4,2,8]
let totalNotas = 0

for (let i = 0; i < calcularPromedio.length; i++) {
    totalNotas = totalNotas + calcularPromedio[i]
}

console.log('El promedio de las notas es de ' + totalNotas / calcularPromedio.length)
*/
